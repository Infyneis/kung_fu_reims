...
const benefitIcons = [Eye, Move, Scale, Bone, Heart, Moon];

export default function TaiChiChuanPage() {
  const t = useTranslations('pages.taichichuan');
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-transparent via-crimson/5 to-transparent">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Circle className="w-12 h-12 text-crimson mx-auto mb-6" />
